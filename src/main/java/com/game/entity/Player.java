...
public class Player {
    ...
    public Player(Long id, String name, String title, Race race, Profession profession,
                  Date birthday, Boolean banned, Integer experience, Integer level,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getName(), getTitle(), getRace(), getProfession(),
                getBirthday(), getBanned(), getExperience(), getLevel(), getUntilNextLevel());
    }
